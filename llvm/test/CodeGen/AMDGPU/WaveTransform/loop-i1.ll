...
define amdgpu_kernel void @loop_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce) {
  ...
  ; GISEL-NEXT:   [[COPY7:%[0-9]+]]:vreg_64 = COPY [[COPY2]]
  ; GISEL-NEXT:   [[COPY8:%[0-9]+]]:vgpr_32 = COPY [[COPY7]].sub0
  ; GISEL-NEXT:   [[COPY9:%[0-9]+]]:vgpr_32 = COPY [[REG_SEQUENCE]].sub0
  ; GISEL-NEXT:   [[COPY10:%[0-9]+]]:vgpr_32 = COPY [[COPY7]].sub1
  ; GISEL-NEXT:   [[COPY11:%[0-9]+]]:vgpr_32 = COPY [[REG_SEQUENCE]].sub1
  ; GISEL-NEXT:   [[V_ADD_CO_U32_e64_:%[0-9]+]]:vgpr_32, [[V_ADD_CO_U32_e64_1:%[0-9]+]]:sreg_32_xm0_xexec = V_ADD_CO_U32_e64 [[COPY8]], [[COPY9]], 0, implicit $exec
  ; GISEL-NEXT:   [[V_ADDC_U32_e64_:%[0-9]+]]:vgpr_32, dead [[V_ADDC_U32_e64_1:%[0-9]+]]:sreg_32_xm0_xexec = V_ADDC_U32_e64 [[COPY10]], [[COPY11]], killed [[V_ADD_CO_U32_e64_1]], 0, implicit $exec
  ...
  ; GISEL-NEXT:   [[S_CSELECT_B32_:%[0-9]+]]:sreg_32 = S_CSELECT_B32 [[S_MOV_B32_5]], [[S_MOV_B32_4]], implicit $scc
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT: bb.3.do.body:
  ; GISEL-NEXT:   successors: %bb.3(0x7c000000), %bb.5(0x04000000)
  ; GISEL-NEXT: {{  $}}
  ; GISEL-NEXT:   [[PHI:%[0-9]+]]:vreg_64 = PHI [[REG_SEQUENCE1]], %bb.2, %40, %bb.3
  ; GISEL-NEXT:   [[PHI1:%[0-9]+]]:vgpr_32 = PHI %80, %bb.3, [[S_CSELECT_B32_]], %bb.2
  ; GISEL-NEXT:   [[PHI2:%[0-9]+]]:vgpr_32 = PHI %36, %bb.3, [[V_AND_B32_e64_]], %bb.2
  ; GISEL-NEXT:   [[S_MOV_B32_6:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   [[COPY12:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_6]]
  ; GISEL-NEXT:   [[V_CMP_NE_U32_e64_:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_NE_U32_e64 [[PHI1]], [[COPY12]], implicit $exec
  ; GISEL-NEXT:   [[GLOBAL_LOAD_DWORD:%[0-9]+]]:vgpr_32 = GLOBAL_LOAD_DWORD [[PHI]], 0, 0, implicit $exec :: (load (s32) from %ir.lsr.iv, addrspace 1)
  ; GISEL-NEXT:   [[S_MOV_B32_7:%[0-9]+]]:sreg_32 = S_MOV_B32 7
  ; GISEL-NEXT:   [[COPY13:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_7]]
  ...
  ; GISEL-NEXT:   [[V_CNDMASK_B32_e64_:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, [[COPY15]], 0, [[COPY14]], [[S_XOR_B32_]], implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_10:%[0-9]+]]:sreg_32 = S_MOV_B32 64
  ; GISEL-NEXT:   [[COPY16:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_10]]
  ; GISEL-NEXT:   [[V_ADD_U32_e64_:%[0-9]+]]:vgpr_32 = nuw V_ADD_U32_e64 [[PHI2]], [[COPY16]], 0, implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_11:%[0-9]+]]:sreg_32 = S_MOV_B32 11
  ; GISEL-NEXT:   [[COPY17:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_11]]
  ; GISEL-NEXT:   [[V_CMP_GT_I32_e64_:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_GT_I32_e64 [[GLOBAL_LOAD_DWORD]], [[COPY17]], implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B:%[0-9]+]]:sreg_64 = S_MOV_B64_IMM_PSEUDO 256
  ; GISEL-NEXT:   [[COPY18:%[0-9]+]]:vreg_64 = COPY [[S_MOV_B]]
  ; GISEL-NEXT:   [[COPY19:%[0-9]+]]:vgpr_32 = COPY [[PHI]].sub0
  ; GISEL-NEXT:   [[COPY20:%[0-9]+]]:vgpr_32 = COPY [[COPY18]].sub0
  ; GISEL-NEXT:   [[COPY21:%[0-9]+]]:vgpr_32 = COPY [[PHI]].sub1
  ; GISEL-NEXT:   [[COPY22:%[0-9]+]]:vgpr_32 = COPY [[COPY18]].sub1
  ; GISEL-NEXT:   [[V_ADD_CO_U32_e64_2:%[0-9]+]]:vgpr_32, [[V_ADD_CO_U32_e64_3:%[0-9]+]]:sreg_32_xm0_xexec = V_ADD_CO_U32_e64 [[COPY19]], [[COPY20]], 0, implicit $exec
  ; GISEL-NEXT:   [[V_ADDC_U32_e64_2:%[0-9]+]]:vgpr_32, dead [[V_ADDC_U32_e64_3:%[0-9]+]]:sreg_32_xm0_xexec = V_ADDC_U32_e64 [[COPY21]], [[COPY22]], killed [[V_ADD_CO_U32_e64_3]], 0, implicit $exec
  ; GISEL-NEXT:   [[REG_SEQUENCE2:%[0-9]+]]:vreg_64 = REG_SEQUENCE [[V_ADD_CO_U32_e64_2]], %subreg.sub0, [[V_ADDC_U32_e64_2]], %subreg.sub1
  ; GISEL-NEXT:   SI_BRCOND %bb.3, [[V_CMP_GT_I32_e64_]]
  ...
  ; GISEL-NEXT:   [[COPY23:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_12]]
  ...
  ; GISEL-NEXT:   [[V_CMP_GT_I32_e64_1:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_GT_I32_e64 [[GLOBAL_LOAD_DWORD_SADDR]], [[COPY25]], implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_14:%[0-9]+]]:sreg_32 = S_MOV_B32 0
  ; GISEL-NEXT:   [[S_MOV_B32_15:%[0-9]+]]:sreg_32 = S_MOV_B32 -1
  ; GISEL-NEXT:   [[COPY26:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_15]]
  ; GISEL-NEXT:   [[COPY27:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_14]]
  ; GISEL-NEXT:   [[V_CNDMASK_B32_e64_1:%[0-9]+]]:vgpr_32 = V_CNDMASK_B32_e64 0, [[COPY27]], 0, [[COPY26]], [[V_CMP_GT_I32_e64_1]], implicit $exec
  ; GISEL-NEXT: {{  $}}
  ...
  ; GISEL-NEXT:   [[COPY28:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_16]]
  ; GISEL-NEXT:   [[V_CMP_NE_U32_e64_1:%[0-9]+]]:sreg_32_xm0_xexec = V_CMP_NE_U32_e64 [[PHI3]], [[COPY28]], implicit $exec
  ; GISEL-NEXT:   [[S_MOV_B32_17:%[0-9]+]]:sreg_32_xm0_xexec = S_MOV_B32 -1
  ; GISEL-NEXT:   [[S_XOR_B32_1:%[0-9]+]]:sreg_32_xm0_xexec = S_XOR_B32 [[V_CMP_NE_U32_e64_1]], [[S_MOV_B32_17]], implicit-def dead $scc
  ; GISEL-NEXT:   SI_BRCOND %bb.7, [[S_XOR_B32_1]]
  ...
  ; GISEL-NEXT:   [[S_MOV_B32_18:%[0-9]+]]:sreg_32 = S_MOV_B32 2
  ; GISEL-NEXT:   [[COPY31:%[0-9]+]]:vgpr_32 = COPY [[S_MOV_B32_18]]
  ...
  ; GISEL-NEXT:   GLOBAL_STORE_DWORD [[REG_SEQUENCE4]], [[PHI4]], 0, 0, implicit $exec :: (store (s32) into %ir.arrayidx13, addrspace 1)
  ; GISEL-NEXT: {{  $}}
