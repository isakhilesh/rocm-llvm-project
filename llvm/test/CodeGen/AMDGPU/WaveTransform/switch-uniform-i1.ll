...
define amdgpu_kernel void @switch_uniform_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce, i32 %id) {
  ...
  ; GISEL-NEXT:   [[S_LSHL_B64_:%[0-9]+]]:sreg_64 = nuw nsw S_LSHL_B64 [[REG_SEQUENCE]], [[S_MOV_B32_1]], implicit-def dead $scc
  ...
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM %bb.5, [[V_CMP_LT_I32_e64_]]
  ...
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM %bb.7, [[V_CMP_LT_I32_e64_1]]
  ...
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM %bb.8, [[V_CMP_EQ_U32_e64_]]
  ...
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM %bb.9, [[V_CMP_NE_U32_e64_]]
  ...
  ; GISEL-NEXT:   SI_BRCOND_UNIFORM %bb.12, [[S_XOR_B32_]]
  ...
  ; GISEL-NEXT:   [[S_LSHL_B64_1:%[0-9]+]]:sreg_64 = nuw nsw S_LSHL_B64 [[REG_SEQUENCE]], [[S_MOV_B32_13]], implicit-def dead $scc
