...
define amdgpu_kernel void @switch_i1(ptr addrspace(1) %filter.coerce, ptr addrspace(1) %out.coerce) {
  ...
  ; GISEL-NEXT:   SI_BRCOND %bb.5, [[V_CMP_LT_I32_e64_]]
  ...
  ; GISEL-NEXT:   SI_BRCOND %bb.6, [[V_CMP_LT_I32_e64_1]]
  ...
  ; GISEL-NEXT:   SI_BRCOND %bb.7, [[V_CMP_EQ_U32_e64_]]
  ...
  ; GISEL-NEXT:   SI_BRCOND %bb.11, [[S_XOR_B32_]]
  ...
  ; GISEL-NEXT:   [[V_LSHLREV_B32_e64_1:%[0-9]+]]:vgpr_32 = nuw nsw V_LSHLREV_B32_e64 [[COPY28]], [[V_AND_B32_e64_]], implicit $exec
